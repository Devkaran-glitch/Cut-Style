...
const LoginForm: React.FC<LoginFormProps> = ({ role, onSwitchToSignup }) => {
  ...
  To register your barber shop:{" "}
  <a
    href="mailto:cutnstyle.register@gmail.com"
    className="text-primary-600 hover:text-primary-700 font-medium underline"
  >
    cutnstyle.register@gmail.com
  </a>{" "}
  with your shop details and business license. We'll verify and send you a registration link.
</p>
